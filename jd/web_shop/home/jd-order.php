			...
			<li class="fore6 dorpdown" id="ttbar-apps" aid="2_955_6342">
				<div class="dt cw-icon">
					...
					<a target="_blank" href="http://app.jd.com/">手机京东</a>
						...
						<div class="dd dorpdown-layer">				<div class="dd-spacer"></div>				<div class="dd-inner" id="ttbar-apps-main"><div class="dd-spacer"></div><div class="dd-inner"><span class="loading"></span></div>				</div>			</div>					<div class="dd dorpdown-layer">				<div class="dd-spacer"></div>				<div class="dd-inner" id="ttbar-apps-main"><div class="dd-spacer"></div><div class="dd-inner"><span class="loading"></span></div>				</div>			</div>		</li>
			<li class="spacer"></li>
			<li class="fore7 dorpdown" id="ttbar-atte" aid="2_955_6494">
				<div class="dt cw-icon">
					<i class="ci-right"><s>◇</s></i>关注京东
				</div>	
						<div class="dd dorpdown-layer">				<div class="dd-spacer"></div>				<div class="dd-inner" id="ttbar-atte-main"><div class="dd-spacer"></div><div class="dd-inner"><span class="loading"></span></div>				</div>			</div>					<div class="dd dorpdown-layer">				<div class="dd-spacer"></div>				<div class="dd-inner" id="ttbar-atte-main"><div class="dd-spacer"></div><div class="dd-inner"><span class="loading"></span></div>				</div>			</div>		</li>
			<li class="spacer"></li>
...
<div class="w w1 header clearfix">
	<div id="logo">
		<a href="./jd-index.php" class="link1" target="_blank">
		<img src="./images/logo-201305.png" alt="京东商城">
		</a>
        ...
        <a class="btn-ordershow" href="http://order.jd.com/center/list.action" clstag="pageclick|keycount|trade_201602181|31">查看订单</a>
                ...
                <i></i>
                            再次购买
		    						    ...
		    						    <ul class="list-order">
			    					<li class="li-st">
					<div class="fore1">订单号：<a href="http://order.jd.com/center/itemPage.action?orderid=44392478919&amp;PassKey=869D978B2C2CD34F0349D28270FA8950">44392478919</a></div>
					<!-- 货到付款 -->
										   <div class="fore2">货到付款：<strong class="ftx-01">799.00元</strong></div>
					   <div class="fore3">
					                                  							  							      京东快递 &nbsp; 送货时间:
