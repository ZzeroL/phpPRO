...
<html>
	...
	<body>
		...
		<div id='line'></div>
		<div id='mainbody'>
		<div id='main_m'><img src='./images/big_ad.jpg' /></div>
			<div id='main_r'>
				<div id='mr_1'>
				    <h3>京东快报</h3>
					<span>更多 &gt;</span>
					...
					<ul id='notice'>
						<li><b>[特惠]</b>新车1元试驾 到店送好礼</li>
						<li><b>[公告]</b>上京东生鲜 品陕西苹果</li>
						<li><b>[特惠]</b>200元中秋礼券免费领</li>
						<li><b>[公告]</b>安微地区因仓库升级配送延迟</li>
						<li><b>[特惠]</b>每日享折扣京东品质游</li>
					</ul>
				</div>
				<div id='mr_2'><img src="./images/mr_2.png" alt=""></div>
			</div>
		</div>
		<div id='today'>
			<img src="./images/today_1.png" style='width:210px;' alt="">
			<img src="./images/today_2.jpg" alt="">
			<img src="./images/today_3.jpg" alt="">
			<img src="./images/today_4.jpg" alt="">
			<img src="./images/today_5.jpg" alt="">
			<div style='clear:both;'></div>
		</div>
