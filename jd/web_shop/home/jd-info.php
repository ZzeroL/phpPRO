...
<div class="header">
    <div class="logo-con w clearfix">
        ...
        <div class="logo-title">收 货 信 息</div>
...
<div class="container w">
    ...
    <div class="main clearfix">
        <div class="reg-form fl">
            <form action="shouhuoxinxi.php" id="register-form" method="post" novalidate="novalidate" style="width:500px;">

                <div class="form-item form-item-account" id="form-item-account">
                    <label>收　货　人</label>
                   <input type="text" id="form-account" style="" name="shouhuoren" class="field" autocomplete="off" maxlength="20" placeholder="收货人姓名" default="&lt;i class=&quot;i-def&quot;&gt;&lt;/i&gt;支持中文、字母、数字、“-”“_”的组合，4-20个字符">
                    <i class="i-status"></i>
                </div>
                <div class="input-tip">
                    <span></span>
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="lianxidianhua" id="form-pwd" class="field" maxlength="20" placeholder="联系电话" >
                    <i class="i-status"></i>
                ...
                <div class="form-item" style="width:500px;">
                  ...
                  <input type="text" name="shouhuodizhi"   id="form-equalTopwd" class="field" placeholder="收货的具体地址" maxlength="120" default="&lt;i class=&quot;i-def&quot;&gt;&lt;/i&gt;请再次输入密码">
                    <i class="i-status"></i>
