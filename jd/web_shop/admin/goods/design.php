            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="#"><i class="icon-font">&#xe012;</i>商品浏览</a></li>
                        <li><a href="./insert.php"><i class="icon-font">&#xe052;</i>商品添加</a></li>
                    </ul>
                </li>
                <li>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
						...
						<?php 
							...
							//双表联查，查询商品表的同时，把商品在分类的表中查询类型名
							$sql = "select goods.*,type.name from goods,type where goodstype = type.id";
