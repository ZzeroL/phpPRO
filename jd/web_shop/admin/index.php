        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="./users/panduan.php"><i class="icon-font">&#xe008;</i>会员管理</a></li>
                        <li><a href="./type/panduan.php"><i class="icon-font">&#xe005;</i>分类管理</a></li>
                        <li><a href="./goods/panduan.php"><i class="icon-font">&#xe006;</i>商品管理</a></li>
                        <li><a href="./order/design.php"><i class="icon-font">&#xe004;</i>订单管理</a></li>
                    </ul>
					<li>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="#"><i class="icon-font">&#xe001;</i>新增会员</a>
