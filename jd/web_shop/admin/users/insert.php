...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="../type/design.php"><i class="icon-font">&#xe006;</i>分类浏览</a></li>
                        <li><a href="../type/insert.php"><i class="icon-font">&#xe004;</i>分类添加</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">会员管理</a><span class="crumb-step">&gt;</span><span>新增会员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="./doinsert.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
