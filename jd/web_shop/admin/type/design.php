            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="./insert.php"><i class="icon-font">&#xe006;</i>分类添加</a></li>
                    </ul>
					<li>
                    ...
                    <table class="result-tab" width="100%">
						...
						<?php 
							...
							while($res = mysqli_fetch_assoc($result)){
								//处理递进关系
								//通过计数逗号个数判断缩进需要多少个空格
								$m = substr_count($res['path'],",")-1;
								$nbsp = str_repeat("&nbsp",$m*4);
							
						?>
                        <tr>
                            <td class="tc"><?php echo $res['id']?></td>
                            <td><?php echo $nbsp."|-->".$res['name']?></td>
                            <td>
                                <a class="link-update" href="./insert.php?id=<?php echo $res['id']?>">添加子类</a>
